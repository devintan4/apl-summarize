...
const PdfSummary = ({ fileName, summary, onNewUpload }: PdfSummaryProps) => {
  ...
  return (
    <div className="pdf-summary-container">
      {" "}
      {/* Container baru untuk PdfSummary */}
      <header className="hero-header">
        {" "}
        {/* Menggunakan header yang sama untuk konsistensi desain */}
      ...
      <div className="summary-content-wrapper">
        <Card className="summary-main-card">
          <div className="flex gap-2 mb-4 flex-wrap tab-list">
            {" "}
            {/* Menambah margin-bottom dan kelas tab-list */}
            {tabs.map((tab) => (
              <div
                key={tab.id}
          ...
          {activeTab && (
            <>
              <div className="summary-text-area">{activeTab.content}</div>
        ...
        <Card className="upload-new-file-card">
          <p className="text-center font-medium text-gray-700 upload-new-text">
